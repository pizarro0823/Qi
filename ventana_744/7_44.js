...
const createNewProduc = (base, altura, precio_costo,precio_venta) => {

  const ionCard = document.createElement('ion-card');
  const ionCardContenc = document.createElement('ion-card-content');
  ionCardContenc.textContent = base + ' x ' + altura + ' => $ ' + precio_costo +'<--->' + precio_venta;
...
const precio_venta = Math.floor(suma_valores_costo * 1.60);
  ...
  createNewProduc(ba, al, suma_valores_costo,precio_venta)
